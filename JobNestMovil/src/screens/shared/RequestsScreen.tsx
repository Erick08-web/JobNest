...
import { Badge, EmptyState, GhostButton } from '../../components/ui';
import { styles } from '../../styles/theme';
import type { RequestItem, UserType } from '../../types/domain';
import { getRequestStatus, getRequestTitle } from '../../utils/formatters';

export function RequestsScreen({ requests, onRefresh, role }: { requests: RequestItem[]; onRefresh: () => void; role: UserType }) {
  return (
    <View>

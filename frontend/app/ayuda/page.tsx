    ...
    <main className="infoPage">
      ...
      <section className="infoHero">
        <div>
          ...
          <p>Respuestas rápidas para usar JobNest como cliente o prestador.</p>
        </div>
        <aside><ShieldCheck /><strong>Ayuda</strong><span>Experiencia clara y segura</span></aside>
      </section>
